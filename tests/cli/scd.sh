...
pyannote-audio train --to=4 $GITHUB_WORKSPACE/tests/cli/scd $DEBUG
pyannote-audio validate --from=2 --to=4 --every=2 $GITHUB_WORKSPACE/tests/cli/scd/train/$DEBUG.train $DEBUG
